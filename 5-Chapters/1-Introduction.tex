...
\end{figure}
\newpage
When the author attended the Hannover Messe 2024 exhibition, 
he observed a real-world application very similar to his master's thesis. 
The sensor testing platform built by Hochschule Stralsund consists of a mmWave radar, 
an RGB camera, an infrared camera, a pair of LiDAR sensors, and a GPS. 
The main purpose of this platform is to assist a captain in spotting and 
tracking obstacles and determining whether an obstacle is in the ship's trajectory. 
What makes this platform unique is the combination of sensors, 
...
\begin{figure}[hpbt]
    ...
    \caption{Maritime sensors by Hochschule Stralsund}
